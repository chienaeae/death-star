...
export function BoardColumn(props: BoardColumnProps) {
  ...
  return (
    <div className="flex flex-col bg-gray-100/80 rounded-xl w-80 max-h-full flex-shrink-0 animate-in fade-in zoom-in-95 duration-300">
      {/* Column Header */}
      <div className="p-3 pb-2 flex items-center justify-between group">
        ...
        <span className="text-xs text-gray-500 font-medium bg-gray-200/50 px-2 py-0.5 rounded-full">
      ...
      <div
        ref={setNodeRef}
        className="flex-1 overflow-y-auto px-2 pb-2 space-y-2 relative min-h-[150px] scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-transparent"
      >
        ...
        {isAdding ? (
          <form 
            ...
            className="p-2 border-2 border-primary border-dashed bg-white rounded-lg shadow-sm"
          >
            <textarea
              autoFocus
          ...
          <button
            ...
            className="flex items-center gap-2 text-gray-500 hover:bg-gray-200/50 hover:text-gray-700 w-full p-2 mt-1 rounded-lg text-sm font-medium transition-colors"
          >
