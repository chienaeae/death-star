...
class MinioStorageStrategyTest {
    ...
    void testGeneratePresignedUploadUrl_RewritesHostname() throws MalformedURLException {
        // Arrange
        URL internalDockerUrl =
                new URL(
                        "http://minio:9000/deathstar-assets/test-key.jpg?X-Amz-Algorithm=AWS4-HMAC-SHA256&X-Amz-Signature=xyz");
        ...
        MinioStorageStrategy strategy =
                new MinioStorageStrategy(s3Presigner, "deathstar-assets", "http://localhost:9000");

        // Act
        URL resultUrl =
                strategy.generatePresignedUploadUrl(
                        "test-key.jpg", "image/jpeg", Duration.ofMinutes(15));
    ...
    void testGeneratePresignedUploadUrl_NoRewriteIfPublicUrlIsBlank() throws MalformedURLException {
        // Arrange
        URL internalDockerUrl =
                new URL("http://minio:9000/deathstar-assets/test-key.jpg?X-Amz-Signature=xyz");
        ...
        MinioStorageStrategy strategy =
                new MinioStorageStrategy(s3Presigner, "deathstar-assets", "");
