...
public interface LoomClient {
    ...
    /**
     * Creates a new Item with a generated UUID.
     * Emits an ITEM_CREATED event, followed by property update events.
     */
    UUID createItem(String itemType, Map<UUID, Object> initialProperties);

    /**
     * Creates a new Item with a specific UUID.
     * Emits an ITEM_CREATED event, followed by property update events.
     */
    UUID createItemWithId(UUID itemId, String itemType, Map<UUID, Object> initialProperties);

    /**
     * Updates an existing item with multiple property patches.
     * Uses optimistic concurrency control based on the currentVersion.
     * 
